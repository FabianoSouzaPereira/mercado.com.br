<?php 
	...
	if(!empty($_POST)){
		...
		if($valida==true){
			...
			//Converter a data de nascimento para banco
			$data_nascimento = Conversor::dataUsuarioParaBanco($data_nascimento);
			
			//Montar o sql de insert
			$sql = "INSERT INTO
						clientes (nome, data_nascimento, telefone, email, cidade_id) 
					VALUES ('$nome', '$data_nascimento', '$telefone', '$email', $cidade_id)";
...
<form action="" method="post"  class="panel panel-warning">
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<input type="text" value="<?php echo @$_POST['fnome']; ?>" class="form-control" name="fnome" id="nome" placeholder="Digite o nome do cliente"  >
		</div>
		
		<div class="form-group">
			<label for="data_nascimento">Data Nascimento</label>
			<input type="text" value="<?php echo @$_POST['fdata_nascimento']; ?>" class="form-control mascaraData" name="fdata_nascimento" id="data_nascimento" placeholder="Digite a data de nascimento"  >
		</div>
		
		<div class="form-group">
			<label for="telefone">Telefone</label>
			<input type="text"  value="<?php echo @$_POST['ftelefone']; ?>" class="form-control mascaraTelefone" name="ftelefone" id="telefone" placeholder="Digite o telefone do cliente"  >
		</div>
		
		<div class="form-group">
			<label for="email">E-mail</label>
			<input type="text" value="<?php echo @$_POST['femail']; ?>" class="form-control" name="femail" id="email" placeholder="Digite o e-mail do cliente"  >
		</div>

...
<div class="formulario">
	...
	<div class="panel-heading"><h4>Excluindo funcionário <?php echo $funcionario['nome']; ?></h4></div>
		<div class="panel-body">
			Deseja realmente excluir o funcionário <b><?php echo $funcionario['nome']; ?></b>?
			<br><br>
			<div>
				<a href="index.php?pagina=funcionarios_excluir&id=<?php echo $id; ?>&confirmar" class="btn btn-success">Confirmar Exclusão</a>
				<a href="index.php?pagina=funcionarios_listar" class="btn btn-danger">Cancelar</a>
			</div>
		</div>
	</div>
</div>